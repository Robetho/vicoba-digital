...
$loan = $conn->query("SELECT l.*, CONCAT(b.lastname,', ',b.firstname,' ',b.middlename) AS name, b.contact_no, b.address FROM loan_list l INNER JOIN borrowers b ON b.id = l.borrower_id WHERE b.id = '$user_id'");
...
<div class="row">
	<div class="col-md-5">
		<div class="form-group">
			...
			<input name="payee" class="form-control" readonly required="" value="<?php echo isset($payee) ? $payee : (isset($meta['name']) ? $meta['name'] : '') ?>">
		</div>
	</div>
