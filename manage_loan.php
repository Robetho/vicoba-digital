	...
	<form action="" id="loan-application">
		...
		<div class="row">
			<div class="col-md-6">
				...
				$borrower = $conn->query("SELECT *,concat(lastname,', ',firstname,' ',middlename) as name FROM borrowers where id = '$borrower_id' order by concat(lastname,', ',firstname,' ',middlename) asc ");
				?>
