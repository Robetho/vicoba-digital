				...
				<table class="table table-bordered" id="loan-list">
					...
					<tbody>
						<?php
							...
							$qry = $conn->query("SELECT l.*,concat(b.lastname,', ',b.firstname,' ',b.middlename)as name, b.contact_no, b.address from loan_list l inner join borrowers b on b.id = l.borrower_id where b.id = '$id'  order by id asc");
...
<script>
	...
	$('#new_application').click(function(){
		uni_modal("New Loan Application","u-manage-loan.php",'mid-large')
	})
