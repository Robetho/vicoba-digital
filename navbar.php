...
<nav id="sidebar" class='mx-lt-5 bg-dark' >
		...
		<div class="sidebar-list">
				...
				<a href="index.php?page=vicoba_report" class="nav-item nav-loans"><span class='icon-field'><i class="fa fa-file-invoice-dollar"></i></span> Vicoba report</a>
				...
				<a href="index.php?page=savings_list" class="nav-item nav-loans"><span class='icon-field'><i class="fa fa-file-invoice-dollar"></i></span> Saving Lists</a>
				...
				<a href="index.php?page=admin_messages" class="nav-item nav-loan_type">
				        <i class="fa fa-comments"></i>
				        <span>Borrower Messages</span>
				</a>	
				<a href="index.php?page=bulk_messages" class="nav-item nav-payments"><span class='icon-field'><i class="fa fa-money-bill"></i></span> Bulk messages</a>	
